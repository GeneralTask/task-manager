...
func TestThreadDetail(t *testing.T) {
	...
	t.Run("Success", func(t *testing.T) {
		...
		assert.NoError(t, err)
		assert.Equal(t,
			fmt.Sprintf("{\"id\":\"%s\",\"deeplink\":\"\",\"is_task\":false,\"source\":{\"account_id\":\"\",\"name\":\"Gmail\",\"logo\":\"/images/gmail.svg\",\"logo_v2\":\"gmail\",\"is_replyable\":true},\"emails\":[{\"smtp_id\":\"sample_smtp_1\",\"subject\":\"test subject 1\",\"body\":\"test body 1\",\"sent_at\":\"2019-04-19T19:00:00-05:00\",\"is_unread\":true,\"sender\":{\"name\":\"test\",\"email\":\"test@generaltask.com\",\"reply_to\":\"test-reply@generaltask.com\"},\"recipients\":{\"to\":[{\"name\":\"p1\",\"email\":\"p1@gmail.com\"}],\"cc\":[{\"name\":\"p2\",\"email\":\"p2@gmail.com\"}],\"bcc\":[{\"name\":\"p3\",\"email\":\"p3@gmail.com\"}]}},{\"smtp_id\":\"sample_smtp_1\",\"subject\":\"test subject 2\",\"body\":\"test body 2\",\"sent_at\":\"2018-04-19T19:00:00-05:00\",\"is_unread\":false,\"sender\":{\"name\":\"test\",\"email\":\"test@generaltask.com\",\"reply_to\":\"\"},\"recipients\":{\"to\":[],\"cc\":[],\"bcc\":[]}}]}", threadIDHex),
			string(body))
	})
}
