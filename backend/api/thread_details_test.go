...
func TestThreadDetail(t *testing.T) {
	...
	t.Run("Success", func(t *testing.T) {
		...
		assert.NoError(t, err)
		assert.Equal(t,
			fmt.Sprintf("{\"id\":\"%s\",\"deeplink\":\"\",\"is_task\":false,\"source\":{\"account_id\":\"\",\"name\":\"Gmail\",\"logo\":\"/images/gmail.svg\",\"logo_v2\":\"gmail\",\"is_replyable\":true},\"emails\":[{\"message_id\":\"000000000000000000000000\",\"subject\":\"test subject 1\",\"body\":\"test body 1\",\"sent_at\":\"2019-04-20T00:00:00Z\",\"is_unread\":true,\"sender\":{\"name\":\"test\",\"emailResponse\":\"test@generaltask.com\",\"reply_to\":\"test-reply@generaltask.com\"},\"recipients\":{\"to\":[{\"name\":\"p1\",\"emailResponse\":\"p1@gmail.com\"}],\"cc\":[{\"name\":\"p2\",\"emailResponse\":\"p2@gmail.com\"}],\"bcc\":[{\"name\":\"p3\",\"emailResponse\":\"p3@gmail.com\"}]}},{\"message_id\":\"000000000000000000000000\",\"subject\":\"test subject 2\",\"body\":\"test body 2\",\"sent_at\":\"2018-04-20T00:00:00Z\",\"is_unread\":false,\"sender\":{\"name\":\"test\",\"emailResponse\":\"test@generaltask.com\",\"reply_to\":\"\"},\"recipients\":{\"to\":[],\"cc\":[],\"bcc\":[]}}]}", threadIDHex),
			string(body))
	})
}
