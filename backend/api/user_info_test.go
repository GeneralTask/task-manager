...
func TestUserInfo(t *testing.T) {
	...
	t.Run("SuccessGet", func(t *testing.T) {
		...
		assert.Equal(t, "{\"agreed_to_terms\":false,\"opted_into_marketing\":false,\"name\":\"\",\"email\":\"userinfo@generaltask.com\"}", string(body))
	})
	...
	t.Run("SuccessUpdate", func(t *testing.T) {
		...
		body, err = ioutil.ReadAll(recorder.Body)
		assert.NoError(t, err)
		assert.Equal(t, "{\"agreed_to_terms\":true,\"opted_into_marketing\":true,\"name\":\"\",\"email\":\"userinfo@generaltask.com\"}", string(body))
	})
	t.Run("SuccessPartialUpdate", func(t *testing.T) {
		...
		body, err = ioutil.ReadAll(recorder.Body)
		assert.NoError(t, err)
		assert.Equal(t, "{\"agreed_to_terms\":true,\"opted_into_marketing\":false,\"name\":\"\",\"email\":\"userinfo@generaltask.com\"}", string(body))
	})
}
