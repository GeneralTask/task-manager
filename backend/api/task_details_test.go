...
func TestTaskDetail(t *testing.T) {
	...
	t.Run("SuccessTaskFromEmail", func(t *testing.T) {
		...
		body := ServeRequest(t, authToken, "GET", fmt.Sprintf("/tasks/detail/%s/", task.ID.Hex()),
			nil, http.StatusOK)
		assert.Equal(t,
			fmt.Sprintf(`{"id":"%s","id_ordering":0,"source":{"name":"Gmail","logo":"/images/gmail.svg","logo_v2":"gmail","is_completable":true,"is_replyable":true},"deeplink":"","title":"sample title","body":"sample body","sender":"","due_date":"","time_allocated":0,"sent_at":"1970-01-01T00:00:00Z","is_done":false,"linked_email_thread":{"thread_id":"sample_gmail_thread_id","last_updated_at":"1969-12-31T18:00:00-06:00","emails":[{"message_id":"%s","smtp_id":"sample_smtp_1","thread_id":"","email_id":"sample_gmail_thread_id","subject":"test subject 1","body":"test body 1","sender_domain":"gmail","sender_email":"test@generaltask.com","sender_name":"test","reply_to":"test-reply@generaltask.com","is_unread":true,"recipients":{"to":[{"name":"p1","email":"p1@gmail.com"}],"cc":[{"name":"p2","email":"p2@gmail.com"}],"bcc":[{"name":"p3","email":"p3@gmail.com"}]},"sent_at":"2019-04-19T19:00:00-05:00"},{"message_id":"000000000000000000000000","smtp_id":"sample_smtp_1","thread_id":"","email_id":"sample_gmail_thread_id","subject":"test subject 2","body":"test body 2","sender_domain":"gmail","sender_email":"test@generaltask.com","sender_name":"test","reply_to":"","is_unread":true,"recipients":{"to":null,"cc":null,"bcc":null},"sent_at":"2018-04-19T19:00:00-05:00"}]},"linked_email_id":"%s"}`,
				task.ID.Hex(), firstEmailID.Hex(), firstEmailID.Hex()),
			string(body))
	})
}
