...
func TestGetSettingsOptions(t *testing.T) {
	...
	t.Run("Success", func(t *testing.T) {
		...
		assert.NoError(t, err)
		assert.Equal(t, 25, len(*settings))
		...
		assert.Equal(t, insertedViewID+"_github_filtering_preference", (*settings)[13].FieldKey)
		assert.Equal(t, insertedViewID+"_github_sorting_preference", (*settings)[14].FieldKey)
		assert.Equal(t, insertedViewID+"_github_sorting_direction", (*settings)[15].FieldKey)
		assert.Equal(t, insertedSectionID+"_task_sorting_preference_main", (*settings)[16].FieldKey)
		assert.Equal(t, insertedSectionID+"_task_sorting_direction_main", (*settings)[17].FieldKey)
		assert.Equal(t, insertedSectionID+"_task_sorting_preference_overview", (*settings)[18].FieldKey)
		assert.Equal(t, insertedSectionID+"_task_sorting_direction_overview", (*settings)[19].FieldKey)
		assert.Equal(t, "000000000000000000000001_task_sorting_preference_main", (*settings)[20].FieldKey)
		assert.Equal(t, "000000000000000000000001_task_sorting_direction_main", (*settings)[21].FieldKey)
		assert.Equal(t, "000000000000000000000001_task_sorting_preference_overview", (*settings)[22].FieldKey)
		assert.Equal(t, "000000000000000000000001_task_sorting_direction_overview", (*settings)[23].FieldKey)
		calendarSetting := (*settings)[24]
