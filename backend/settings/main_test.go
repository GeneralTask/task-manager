...
func TestGetSettingsOptions(t *testing.T) {
	...
	t.Run("Success", func(t *testing.T) {
		...
		assert.NoError(t, err)
		assert.Equal(t, 19, len(*settings))
		...
		assert.Equal(t, insertedViewID+"_github_filtering_preference", (*settings)[7].FieldKey)
		assert.Equal(t, insertedViewID+"_github_sorting_preference", (*settings)[8].FieldKey)
		assert.Equal(t, insertedViewID+"_github_sorting_direction", (*settings)[9].FieldKey)
		assert.Equal(t, insertedSectionID+"_task_sorting_preference_main", (*settings)[10].FieldKey)
		assert.Equal(t, insertedSectionID+"_task_sorting_direction_main", (*settings)[11].FieldKey)
		assert.Equal(t, insertedSectionID+"_task_sorting_preference_overview", (*settings)[12].FieldKey)
		assert.Equal(t, insertedSectionID+"_task_sorting_direction_overview", (*settings)[13].FieldKey)
		assert.Equal(t, "000000000000000000000001_task_sorting_preference_main", (*settings)[14].FieldKey)
		assert.Equal(t, "000000000000000000000001_task_sorting_direction_main", (*settings)[15].FieldKey)
		assert.Equal(t, "000000000000000000000001_task_sorting_preference_overview", (*settings)[16].FieldKey)
		assert.Equal(t, "000000000000000000000001_task_sorting_direction_overview", (*settings)[17].FieldKey)
		calendarSetting := (*settings)[18]
