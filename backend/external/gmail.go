...
func (gmailSource GmailSource) ModifyEvent(userID primitive.ObjectID, accountID string, eventID primitive.ObjectID, updateFields *database.CalendarEventChangeableFields) error {
	return errors.New("has not been implemented yet")
}
